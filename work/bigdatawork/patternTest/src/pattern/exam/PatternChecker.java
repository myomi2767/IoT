...
public class PatternChecker {
    ...
    public static boolean isNum(String str) {
    	boolean checker = Pattern.matches("[\\d^ ]+", str);
    	return checker;
    }
     
   //** 영문으로만 구성되었는지에 대한 형식 검사 *//*
    public static boolean isEng(String str) {
    	boolean checker = Pattern.matches("[A-z ]+", str);
    	return checker;
    }
   //** 한글로만 구성되었는지에 대한 형식 검사 *//*
    public static boolean isKor(String str) {
    	boolean checker = Pattern.matches("[ㄱ-힣 ]+", str);
    	return checker;
    }
     
    //** 영문과 숫자로만 구성되었는지에 대한 형식 검사 *//*
    public static boolean isEngNum(String str) {
    	boolean checker = Pattern.matches("[\\w ]+", str);
    	return checker;
    }
     
    //** 한글과 숫자로만 구성되었는지에 대한 형식 검사 *//*
    public static boolean isKorNum(String str) {
    	boolean checker = Pattern.matches("[ㄱ-힣0-9 ]+", str);
    	return checker;
    }
     
   //** 이메일 형식인지에 대한 검사 --> "아이디@도메인"의 형식을 충족해야 한다. *//*
    public static boolean isEmail(String str) {
    	boolean checker = Pattern.matches("[\\w]+@[\\w]+\\.[a-z]{2,3}+", str);
    	return checker;
    }
 ...
 /*   public static boolean isIP(String str) {
    	boolean checker = Pattern.matches("[0-9]+", str);
    	return checker;
    }*/
