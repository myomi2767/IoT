...
/*
    ...
    따라서 내부에서 자동으로 전달될 수 있도록 작업 - version2로 바뀌면서 적용된 내용
    0. FragmentManager를 이용해서 SupportMapFragment를 find
    1. OnMapReadyCallback을 구현하고 onMapReady메소드를 오버라이딩
    2. SupportMapFragment객체에 getMapAsync메소드를 이용해서 1번에서 구현한 OnMapReadyCallback을객체를 연결
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(map!=null){
            ...
            */
            ...
            //map.moveCamera(CameraUpdateFactory.newLatLngZoom(myloc,14));

            //카메라의 정보를 담고 있는 객체
            //target() - 화면에 출력되기 위해서 특정위치의 중앙으로 이동
    ...
    public void setPosition(View view){
        LatLng myloc = new LatLng(37.5000801,127.0328209);
    ...
    public void addCircle(View view){
        ...
        circleOptions.center(new LatLng(37.5000801,127.0328209));//circle의 중심
