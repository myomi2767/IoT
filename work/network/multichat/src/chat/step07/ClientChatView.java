...
public class ClientChatView extends JFrame {
	...
	public ClientChatView(String ip, int port, String nickname) {
		...
		//새로운 사용자의 정보가 nicknamelist에 저장되어 있고 그 벡터를 JList에 출력
	...
	private void filteringMsg(String msg) {
		...
		String protocol = st.nextToken();//어떤 작업을 했는지 알 수 있는 keyword - new, old, chatting....
		String message = st.nextToken();
		System.out.println("포로토콜:"+protocol+",메시지:"+message);
